/**
 *
    Given an integer array nums and an integer val, remove all occurrencesof val in
 ...
 * @return {number}
    ...
    Use a variable k to store the position for the next
    valid value (!= val) in the nums array.

    For each valid value found, increment k by one.
 */
